                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select autofocus="" id="email_type" name="email_type" class="form-control">
                                        ...
                                        ?>
                                            <option value="<?php echo $method_key ?>" <?php if (set_value('email_type', $emaillist->email_type) == $method_key) echo "selected=selected" ?>>
                            ...
                            <div class="is_disabled <?php echo $display; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="name" name="smtp_security" class="form-control">
                                            <option value="" <?php if (set_value('email_type', $emaillist->ssl_tls) == "") echo "selected=selected" ?>>OFF</option>
                                            <option value="ssl" <?php if (set_value('email_type', $emaillist->ssl_tls) == "ssl") echo "selected=selected" ?>>SSL</option>
                                            <option value="tls" <?php if (set_value('email_type', $emaillist->ssl_tls) == "tls") echo "selected=selected" ?>>TLS</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
