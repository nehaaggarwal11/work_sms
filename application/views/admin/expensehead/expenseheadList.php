    ...
    <section class="content">
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('expense_head', 'can_edit')) {
                ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/expensehead/edit/<?php echo $category['id'] ?>" class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
            ...
            if ($this->rbac->hasPrivilege('expense_head', 'can_delete')) {
                ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/expensehead/delete/<?php echo $category['id'] ?>"class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
