            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> Assign Hostel</h3>
                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($sch_setting->father_name) {  ?>
													<td><?php echo $student['father_name']? $student['father_name'] : $student['guardian_name']   ?></td>
													<?php }?>
                                                    <td><?php
                                                        if ($student["dob"] != null) {
  ...
  $display_field= "<a href=".$student[$fields_value->name]." target='_blank'>".$student[$fields_value->name]."</a>";
                                                    ...
                                                    <td class="pull-right">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>admin/hostel/student_hostel_save/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
