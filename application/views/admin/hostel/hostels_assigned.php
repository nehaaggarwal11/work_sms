                ...
                <div class="col-md-12">
                    ...
                    <?php if ($this->session->flashdata('flsh_msg')) {?>
                        ...
                        <div class="box-header" style="display:inline-block">
                            <h3 class="box-title"><i class="fa fa-search"></i>Hostels Assigned </h3>
                        </div>
                                                ...
                                                foreach ($students as $st) {
                                                    ...
                                                    <td class="pull-right">
                                                        ...
                                                        if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>admin/hostel/hostelleave/<?php echo $st['sid'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
