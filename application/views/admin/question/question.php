                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php echo findOption($questionOpt, $subject_value->correct);
                                                                        ?></td>
                                            <td class="pull-right">
...
?>
<div class="sdh-clone-question hidden">
    <div class="form-group">
        ...
        <textarea class="form-control ckeditor" name="question[]"></textarea>
    ...
    ?>
        <div class="form-group">
            ...
            <textarea class="form-control ckeditor" name="<?php echo $question_opt_key; ?>[]"></textarea>
            ...
            <form action="<?php echo site_url('admin/question/add'); ?>" method="POST" id="formsubject">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="sdh_sub" name="subject_id[]">
                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                            <?php
                    ...
                    <div class="sdh-question">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="sdh_correct" name="correct[]">
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <?php
                                foreach ($questionOpt as $question_opt_key => $question_opt_value) {
                                ?>
                    ...
                    <div id="sdh_add_question"></div>
                </div>
                <div class="modal-footer">
                    <button id="sdh-add-quest-btn" type="addquest" class="btn btn-danger"><?php echo $this->lang->line('add') . ' Question' ?></button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#sdh-add-quest-btn').click((event) => {
            ...
            $("#sdh_add_question .ckeditor").each(function(_, ckeditor) {
        ...
        $(document).on('click', '.question-btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    if (data.status) {
                        $('#sdh_sub').val(data.result.subject_id);
                        $('#sdh_correct').val(data.result.correct);
