                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control dob" value="<?php
                                        ...
                                        <?php if ($sch_setting->staff_date_of_joining) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="date_of_joining" name="date_of_joining" placeholder="" type="text" class="form-control measure_date" value="<?php
