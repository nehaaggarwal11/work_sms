            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="number" name="contact" placeholder="" type="tel" onblur="addHyphen(this)" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" value="<?php echo set_value('contact', $enquiry_data['contact']); ?>" />
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="email" value="<?php echo set_value('email', $enquiry_data['email']); ?>" name="email" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="source" class="form-control">
                            ...
                            <?php foreach ($source as $key => $value) { ?>
                                <option value="<?php echo $value['source']; ?>" <?php if ($enquiry_data['source'] == $value['source']) {
                                                                                    echo "selected";
