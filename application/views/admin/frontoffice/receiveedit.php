                        ...
                        <form id="form1" action="<?php echo site_url('admin/receive/editreceive/' . $receiveData['id']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="<?php echo set_value('ref_no', $receiveData['reference_no']); ?>" name="ref_no">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control measure_date" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($receiveData['date']))); ?>" readonly="readonly" />
