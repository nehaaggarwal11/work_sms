                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="issue_date" name="issue_date" placeholder="" type="text" class="form-control issueDate" value="<?php echo set_value('issue_date'); ?>" readonly />
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="return_date" name="return_date" placeholder="" type="text" data-toggle="tooltip"  data-original-title="Please Select Issue Date" class="form-control rangeReturnDate" value="<?php echo set_value('return_date'); ?>" readonly />
