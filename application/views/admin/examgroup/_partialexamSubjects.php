...
<div class="row">
    <div class="col-md-12 pt5">
        <button type="button" name="add" class="btn btn-primary btn-sm add pull-right" autocomplete="off"><span class="fa fa-plus"></span> <?php echo $this->lang->line('add')."/". $this->lang->line('edit') . " " . $this->lang->line('exam') . " " . $this->lang->line('subject'); ?></button>
    </div>
</div>
<form action="<?php echo site_url('admin/examgroup/addexamsubject') ?>" method="POST" class="ssaddSubject ptt10 autoscroll">
    ...
    <div class="">
        <table class="table table-bordered" id="item_table">
            <thead>
                <tr>
                    <th class=""><?php echo $this->lang->line('subject'); ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('date'); ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('time'); ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('duration') ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('credit') . " " . $this->lang->line('hours') ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('room') . " " . $this->lang->line('no') ?></th>
                    <th class=""><?php echo $this->lang->line('marks') . " (" . $this->lang->line('max') . ".)"; ?><span class="text-danger">*</span></th>
                    <th class=""><?php echo $this->lang->line('marks') . " (" . $this->lang->line('min') . ".)"; ?><span class="text-danger">*</span></th>
                    <?php
