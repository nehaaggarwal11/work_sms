                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control dob" value="<?php echo set_value('dob'); ?>" />
                                                <span class="text-danger"><?php echo form_error('dob'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="Age">Age (as on today)</label><small class="req"> *</small>
                                                <input id="ageToday" placeholder="" type="text" class="form-control ageToday" readonly />
                                                <span class="text-danger"><?php echo form_error('dob'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <?php if ($sch_setting->category) {  ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('category'); ?> <small class="req">*</small></label>
                                        ...
                                        if ($sch_setting->mobile_no) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobileno" onkeyup="addHyphen(this)" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" name="mobileno" placeholder="" type="text" class="form-control" value="<?php echo set_value('mobileno'); ?>" />
                                ...
                                <div class="around10">
                                        ...
                                        <?php if ($sch_setting->father_name) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_name" name="father_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('father_name'); ?>" required />
                                        ...
                                        if ($sch_setting->father_phone) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_phone" onkeyup="addHyphen(this)" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" name="father_phone" placeholder="" type="text" class="form-control" value="<?php echo set_value('father_phone'); ?>" required />
                                    ...
                                    <div class="row">
                                        <?php if ($sch_setting->mother_name) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('mother_name'); ?><small class="req"> *</small></label>
                                                    <input id="mother_name" name="mother_name" placeholder="" type="text" class="form-control" value="<?php echo set_value('mother_name'); ?>" required />
                                        ...
                                        if ($sch_setting->mother_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_phone" onkeyup="addHyphen(this)" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" name="mother_phone" placeholder="" type="text" class="form-control" value="<?php echo set_value('mother_phone'); ?>" required />
                                    ...
                                    <div id="gaurdian_radio" class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_name" name="guardian_name" placeholder="" type="text" class="form-control" data-toggle="tooltip" data-original-title="SELECT 'If Guardian Is'" value="<?php echo set_value('guardian_name'); ?>" readonly required />
                                                ...
                                                <?php if ($sch_setting->guardian_relation) { ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_relation" name="guardian_relation" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_relation');  ?>" readonly required />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_phone" name="guardian_phone" placeholder="" onkeyup="addHyphen(this)" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="12" type="text" class="form-control" value="<?php echo set_value('guardian_phone'); ?>" required required />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_occupation" name="guardian_occupation" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_occupation'); ?>" readonly />
                                        ...
                                        <?php if ($sch_setting->guardian_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="guardian_email" name="guardian_email" placeholder="" type="email" class="form-control" value="<?php echo set_value('guardian_email'); ?>" required required />
...
<script type="text/javascript">
    ...
    $('input:radio[name="guardian_is"]').change(
        function() {
            $('#guardian_name').removeAttr('data-toggle');
            if ($(this).is(':checked')) {
                var value = $(this).val();
                if (value == "father") {
                    ...
                    $('#guardian_name').removeAttr('readonly').val("");
                    $('#guardian_phone').removeAttr('readonly').val("");
                    $('#guardian_occupation').removeAttr('readonly').val("");
                    $('#guardian_relation').removeAttr('readonly').val("")
                }
            }
        });
</script>
