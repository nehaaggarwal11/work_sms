                                        ...
                                        if ($sch_setting->mobile_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobileno" name="mobileno" type="tel" onblur="addHyphen(this)" maxlength="10" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" value="<?php echo set_value('mobileno', $student['mobileno']); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" rows="3" placeholder="" name="house">
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $hvalue["id"] ?>" <?php if ($hvalue["id"] == $student["school_house_id"]) {
                                                                                                            echo "selected";
                                        ...
                                        if ($sch_setting->father_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_phone" name="father_phone" placeholder="" type="tel" onblur="addHyphen(this)" maxlength="10" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" value="<?php echo set_value('father_phone', $student['father_phone']); ?>" />
                                        ...
                                        if ($sch_setting->mother_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_phone" name="mother_phone" type="tel" onblur="addHyphen(this)" maxlength="10" placeholder="012-345-6789" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" value="<?php echo set_value('mother_phone', $student['mother_phone']); ?>" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_name" name="guardian_name" data-toggle="tooltip" data-original-title="SELECT 'If Guardian Is'" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_name', $student['guardian_name']);?>" readonly/>
                                                ...
                                                <?php if ($sch_setting->guardian_relation) { ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_relation" name="guardian_relation" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_relation', $student['guardian_relation']); ?>" readonly/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_phone" name="guardian_phone" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_phone', $student['guardian_phone']); ?>" readonly/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_occupation" name="guardian_occupation" placeholder="" type="text" class="form-control" value="<?php echo set_value('guardian_occupation', $student['guardian_occupation']); ?>" readonly/>
                                        ...
                                        <?php if ($sch_setting->guardian_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="guardian_email" name="guardian_email" placeholder="" type="email" class="form-control" value="<?php echo set_value('guardian_email', $student['guardian_email']); ?>" />
