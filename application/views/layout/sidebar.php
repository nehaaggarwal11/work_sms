            ...
            if ($this->module_lib->hasActive('student_information')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('admin/show_all_students/show'); ?>"><a href="<?php echo base_url(); ?>admin/show_all_students/showlist"><i class="fa fa-angle-double-right"></i><?php echo "Drop Out " . $this->lang->line('student'); ?> </a></li>
                        <?php } ?>
                        </ul>
                    </li>
                <?php
                    ...
                    <li class="treeview <?php echo set_Topmenu('gmeet'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('live_meeting', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('gmeet/live_meeting'); ?>"><a href="<?php echo base_url(); ?>admin/gmeet/meeting"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('live_meeting'); ?></a></li>
                            <?php }
                            if ($this->rbac->hasPrivilege('class_report', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('gmeet/class_report'); ?>"><a href="<?php echo base_url(); ?>admin/gmeet/class_report"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('live_class') . ' ' . $this->lang->line('report'); ?></a></li>
                            <?php }
