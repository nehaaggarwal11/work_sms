            ...
            if ($this->module_lib->hasActive('student_information')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        if ($this->rbac->hasPrivilege('student', 'can_delete')) {
                        ?>
                            <li class="<?php echo set_Submenu('show_all_students/showlist'); ?>"><a href="<?php echo base_url(); ?>admin/show_all_students/showlist"><i class="fa fa-angle-double-right"></i>Drop Out Students</a></li>
                        <?php
                        }
                        ?>
