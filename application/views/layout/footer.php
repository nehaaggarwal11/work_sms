...
<?php } ?>
<script type="text/javascript" src="<?php echo base_url(); ?>backend/dist/js/custom.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#dob').change(function() {
            ...
            console.log(age)
            if (age !== "NaN" && age !== undefined) {
                $('#ageToday').val(age);
            }

        }).blur(function() {
            console.log($('#ageToday').val());
            if ($('#ageToday').val() > 20) {
                alert('Age is more than 20 years');
            }
        })
