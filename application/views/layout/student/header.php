...
<head>
    ...
    <title><?php echo $this->customlib->getAppName().' - '.ucfirst( pathinfo(uri_string(),PATHINFO_BASENAME)); ?></title>
        ...
        <aside class="main-sidebar" id="alert2">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu verttop38" id="sibe-box">
                    ...
                    ?>
                            <li class="<?php echo set_topmenu('Gmeet'); ?>"><a href="<?php echo base_url('user/gmeet'); ?>"><i class="fa fa-video-camera ftlayer"></i> <?php echo $this->lang->line('gmeet_live_classes'); ?></a></li>
                    <?php }
                    } ?>
                    <?php
                    ...
                    if ($this->studentmodule_lib->hasActive('hostel_rooms'))
                        echo set_Submenu('hostelroom/index'); {
                    ?>
