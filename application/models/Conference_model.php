...
class Conference_model extends MY_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->select('conferences.*,for_create.surname as `create_for_surname,create_by.name as `create_by_name`,create_by.surname as `create_by_surname,classes.class,sections.section')->from('conferences');
