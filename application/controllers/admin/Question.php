    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $insert_data = array(
              ...
              $sdh_subject_id = $this->input->post('subject_id');
              $sdh_question   = $this->input->post('question');
              $sdh_opt_a      = $this->input->post('opt_a');
              $sdh_opt_b      = $this->input->post('opt_b');
              $sdh_opt_c      = $this->input->post('opt_c');
              $sdh_opt_d      = $this->input->post('opt_d');
              $sdh_opt_e      = $this->input->post('opt_e');
              $sdh_correct    = $this->input->post('correct');
            ...
            if ($id != 0) {
               ...
               $this->question_model->addBulk($sdh_subject_id,$sdh_question, $sdh_opt_a, $sdh_opt_b, $sdh_opt_c, $sdh_opt_d, $sdh_opt_e, $sdh_correct);
            }
