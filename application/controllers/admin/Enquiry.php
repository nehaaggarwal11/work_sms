...
class Enquiry extends Admin_Controller {
    ...
    public function index() {
        ...
        foreach ($enquiry_list as $key => $value) {
            ...
            $enquiry_list[$key]["followupdate"] = (!empty($follow_up["date"]))? $follow_up["date"]:"";
            $enquiry_list[$key]["next_date"] = (!empty($follow_up["next_date"])) ? $follow_up["next_date"]: "";
            $enquiry_list[$key]["response"] = (!empty($follow_up["response"])) ? $follow_up["response"]: "";
            $enquiry_list[$key]["note"] = (!empty($follow_up["note"])) ? $follow_up["note"]: "";
            $enquiry_list[$key]["followup_by"] = (!empty($follow_up["followup_by"])) ? $follow_up["followup_by"]: "";
        }
