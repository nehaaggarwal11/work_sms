...
class Sections extends Admin_Controller {
    ...
    function index() {
        ...
        foreach($section_result as $result){
            $sdh_section[] = $result['section'];
        }
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if(!in_array($this->input->post('section'), $sdh_section)){
                $this->section_model->add($data);
                $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">'.$this->lang->line('success_message').'</div>');
                redirect('sections/index');
            }
            else{
                $this->session->set_flashdata('msg', '<div class="alert alert-danger text-left">'.$this->lang->line('already_exists').'</div>');
                redirect('sections/index');
            }
